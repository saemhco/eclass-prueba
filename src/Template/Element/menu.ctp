<nav class="navbar navbar-default nav-users">
    <div class="container">
        <div class="navbar-header">
            ...
            <?= $this->Html->link('ECLASS', ['controller' => 'Users', 'action' => 'index'], ['class' => 'navbar-brand']) ?>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <?php if (isset($current_user)) : ?>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <?= $this->Html->link('Ver mi perfil', ['controller' => 'Users', 'action' => 'view', $current_user['id']]) ?></h2>
                    </li>
